            ...
            >
              <div
                className={`relative rounded-full transition-all duration-200 ${
                  isActive
                    ...
                    : 'ring-1 ring-[var(--theme-border)] group-hover:ring-[var(--theme-border)]'
                }`}
              >
                {channel.avatarUrl ? (
                  <img
                  ...
                  <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-[var(--theme-card)] flex items-center justify-center">
              ...
              <span
                className={`text-xs transition-colors duration-200 ${
                  isActive ? 'text-[var(--theme-text)] font-medium' : 'text-[var(--theme-textSecondary)] group-hover:text-[var(--theme-text)]'
                }`}
              >
                {channel.displayName}
              </span>

...
export function cleanTitleFromLabels(title: string): string {
  ...
  const labelsToRemove = [
    ...
    // 格式标签
    '未删减版', '未删节', '完整版无删减', '未删减', '修复版', '重制版', '正片版', '正式版',
    '完结版', '最终版', '电影版', '正片', '完整版', '原版', '全版',
    // 语言标签
    '中文字幕', '英文字幕', '日文字幕', '字幕版', '双语字幕', '中文配音', '英文配音', '日语配音', '韩语配音',
    '中文字', '中字', '字幕', '国语版', '粤语版', '英语版', '日语版', '韩语版',
    '国语', '粤语', '英语', '日语', '韩语', '中文', '双语',
    // 英文标签
    'Full Movie', 'Full HD', 'HD Quality', 'Full Version', 'Uncut', 'Remastered', 'Original', 'Subtitle', 'Subbed', 'Dubbed',
    'Blu-ray', 'Complete', 'Final', 'Movie', 'Film', 'Video',
    'HD', 'BD', 'DVD', '1080p', '720p', '4K',
    // 版本标签
    '（加更版）', '加更版', '动态漫',
    // 类型标签
    '演员篇', '金融季', '常规赛', 'NBA',
    // 其他标签
    '我屯了千亿物资', '在线观看', '免费观看', '完整版全集', '高清全集', '超清全集', '蓝光全集', 'BD全集', 'DVD全集',
    'VS', '在线', '末日', '观看', '全集', '资源', '电影', '影片', '视频', '合集', '系列', '合集版', '系列版',
    // 年份标签
